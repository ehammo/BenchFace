...
import br.ufpe.cin.mpos.net.rpc.RpcClient;
import br.ufpe.cin.mpos.offload.Remotable.Offload;
...
public final class ProxyHandler implements InvocationHandler {
	...
	private Object invokeRemotable(ServerContent server, boolean needProfile, Method method, Object params[]) throws RpcException, ConnectException, GeneralSecurityException {
		rpc.setupServer(server);
		Object returnMethod = rpc.call(needProfile, manualSerialization, objOriginal, method.getName(), cripto, params);
